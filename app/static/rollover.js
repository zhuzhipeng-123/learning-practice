...
async function checkDay(){
 ...
 try{const data=await requestJSON('/api/day-status',{cache:'no-store'});if(data.date!==document.body.dataset.localDate){if(dirty)document.querySelector('#new-day-notice').hidden=false;else location.reload();}}catch{}finally{checking=false;}
}
